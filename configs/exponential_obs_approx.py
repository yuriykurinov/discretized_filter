"""Гауссовская аппроксимация EXPONENTIAL по двум моментам, ht=10.

Одно наблюдение фильтра является суммой 10 шагов ``exponential_obs``.
"""
import numpy as np
